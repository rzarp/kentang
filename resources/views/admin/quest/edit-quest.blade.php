...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-xlg-3 col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('quest.update',['id' => $quest->id]) }}" class="form-horizontal form-material mx-2" method="POST" enctype="multipart/form-data" >
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="col-md-12">Kode</label>
                            <div class="col-md-12">
                                <input type="text" placeholder="Tulis kode gejala" class="form-control form-control-line" name="kode" id="" value="{{ $quest->kode}}" >
                                    @error('kode')
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="Tulis Nama gejala" class="form-control form-control-line" name="gejala" id="" value="{{ $quest->gejala}}">
                                    @error('gejala')
                                        <div class="text-danger">
                                            {{ $message }}
                                        </div>
